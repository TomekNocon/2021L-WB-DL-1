...
with tf.compat.v1.Session(config=config) as sess:
    ...
    # load weights
    #saver.restore(sess, os.path.join(args.weightspath, args.ckptname))            ######### to nie bylo zakomentowacne ale zaraz bedzie
    ...
    progbar = tf.compat.v1.keras.utils.Progbar(total_batch)
